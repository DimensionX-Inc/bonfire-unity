		...
		public TextureExportSettings GetExportSettingsForSlot(string textureSlot)
		{
			...
			switch (textureSlot)
			{
				...
				case TextureMapType.SpecGloss: // SpecGloss = MetallicGloss; // not really supported anymore
					exportSettings.linear = true;
					exportSettings.alphaMode = TextureExportSettings.AlphaMode.Always; // changed from Never -JS
					exportSettings.conversion = TextureExportSettings.Conversion.None; // changed from MetalGlossChannelSwap -JS
					return exportSettings;
